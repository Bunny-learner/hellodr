...
patient.post('/filterdoctors',verifyJWT('patient'),filterdoctors)
patient.post('/updateprofile',verifyJWT('patient'),updateprofile)
patient.get('/cloudcred',cloudcred)
patient.get('/allslots',verifyJWT('patient'),allslots)
patient.get('/getdoctors',verifyJWT('patient'),getdoctors)
...
patient.get('/reviews/:id',verifyJWT('patient'),getreviews)
