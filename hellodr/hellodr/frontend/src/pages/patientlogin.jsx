...
export default function patientlogin() {
  ...
  const onSubmit = async (data) => {
    ...
    const response = await fetch("https://hellodr-server.onrender.com/patient/logindata", {
      method: 'POST',
      headers: {
      ...
      <div className="registration-card">
        <div className="form-header">
         ...
         <div className="social-login-buttons">
                   <a className="social-btn" href="https://hellodr-server.onrender.com/auth/google?type=login">
                     ...
                     <a className="social-btn" href="https://hellodr-server.onrender.com/auth/facebook?type=login"> <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#1877F2"><path d="M22 12c0-5.52-4.48-10-10-10S2 6.48 2 12c0 4.84 3.44 8.87 8 9.8V15H8v-3h2V9.5C10 7.57 11.57 6 13.5 6H16v3h-1.5c-1 0-1.5.5-1.5 1.5V12h3l-.5 3h-2.5v6.8c4.56-.93 8-4.96 8-9.8z" /></svg> Facebook </a>
                  </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="form-body" noValidate>
          ...
          <Link to='/patient/forgot' className='forgot' >forgot password?</Link>
